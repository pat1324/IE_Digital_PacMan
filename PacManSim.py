class PacManSimulator:
    ...
    # Places PacMan on the grid. The use of regex to enforce valid input means that invalid coordinates cannot be passed
    ...
    # Turns PacMan left or right depending on the instruction argument
    ...
    # Moves PacMan one unit in the direction it is facing
    def move(self):

        # invalid moves/corner
        if self.x == self.y == self.min_pos and (self.f == 'WEST' or self.f == 'SOUTH'):
            print("PacMan is in the south west corner facing " + self.f + " and can no longer move forward")
            return
        if self.x == self.y == self.max_pos and (self.f == 'EAST' or self.f == 'NORTH'):
            print("PacMan is in the north east corner facing " + self.f + " and can no longer move forward")
            return
        if self.x == self.min_pos and self.y == self.max_pos and (self.f == 'WEST' or self.f == 'NORTH'):
            print("PacMan is in the north west corner facing " + self.f + " and can no longer move forward")
            return
        ...
        if self.x == self.min_pos and self.f == 'WEST':
            print("PacMan is on the west side of the grid facing " + self.f + " and can no longer move forward")
            return
        if self.x == self.max_pos and self.f == 'EAST':
            print("PacMan is on the east side of the grid facing " + self.f + " and can no longer move forward")
            return
        if self.y == self.min_pos and self.f == 'SOUTH':
            print("PacMan is on the south side of the grid facing " + self.f + " and can no longer move forward")
            return
        if self.y == self.max_pos and self.f == 'NORTH':
            print("PacMan is on the north side of the grid facing " + self.f + " and can no longer move forward")
            return
    ...
    # Reports the current location/coordinates of PacMan
    def report(self):
